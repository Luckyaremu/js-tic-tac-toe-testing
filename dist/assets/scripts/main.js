...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _players_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./players.js */ \"./src/players.js\");\n/* harmony import */ var _gamelogic_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gamelogic.js */ \"./src/gamelogic.js\");\n/* eslint-disable   import/extensions */\n\n\n\nvar gameFlow = function gameFlow() {\n  return {\n    allplayers: [],\n    form: document.querySelector('.name-form'),\n    table: document.querySelector('.table-container'),\n    playerCount: 0,\n    player: null,\n    cellFull: false,\n    changeNodeContent: function changeNodeContent() {\n      var node = document.createElement('LI');\n      node.innerText = '';\n      this.allplayers.forEach(function (val) {\n        node.innerText = \"\".concat(val.name);\n      });\n    },\n    isCellFull: function isCellFull(playerCount) {\n      if (playerCount === 9) {\n        this.cellFull = true;\n      }\n\n      return this.cellFull;\n    },\n    startGame: function startGame() {\n      var _this = this;\n\n      this.form.submitbtn.addEventListener('click', function (e) {\n        e.preventDefault();\n        _this.allplayers = Object(_players_js__WEBPACK_IMPORTED_MODULE_0__[\"setPlayers\"])(_this.allplayers).getPlayers();\n\n        if (_this.allplayers) {\n          _this.changeNodeContent();\n        }\n      });\n      this.table.addEventListener('click', function (e) {\n        if (Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().ValiditePosition(e)) {\n          // set player and run game logic\n          _this.player = Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().playerTurn(_this.allplayers, _this.playerCount);\n          _this.playerCount += 1;\n\n          _this.isCellFull(_this.playerCount);\n\n          Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().playInto(_this.player, e);\n\n          if (Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().checkWin(_this.player)) {\n            var message = \"Wow! \".concat(_this.player.name, \" has won!\");\n            Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().spitResult(message);\n          } else if (Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().checkTie(_this.cellFull)) {\n            var _message = 'Well, It looks like it is a tie!';\n            Object(_gamelogic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])().spitResult(_message);\n          }\n        }\n      });\n    }\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (gameFlow);\n\n//# sourceURL=webpack:///./src/gameflow.js?");
